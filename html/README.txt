Front end website for indycast.net.  There's an admin interface that is
viewable to everyone but only modifiable if the remote ip is ipv6 ::1 ...
...
This is based on the Directive Template from HTML5 UP:
